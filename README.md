...
notification and a localized resume download email through Gmail SMTP after
persistence.
...
| `CLOUDFRONT_URL` | Yes | None | No | Base URL that hosts the resume PDF files |
...
Resume delivery is localized using the SQS `language` field:

| Language | Button | CloudFront file |
| --- | --- | --- |
